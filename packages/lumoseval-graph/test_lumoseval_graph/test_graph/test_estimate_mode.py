...
import pytest
from lumoseval_core.types import ChunkArtifacts, CostEstimate, Inputs, Item
...
def test_node_generation_claims_estimate_calls_estimate_without_chunks(
    ...
    Run: uv run pytest -s packages/lumos-graph/test_lumos_graph/test_graph/test_estimate_mode.py::test_node_generation_claims_estimate_calls_estimate_without_chunks
    """
...
def test_node_grounding_estimate_calls_estimate_without_claim_artifact(
    ...
    Run: uv run pytest -s packages/lumos-graph/test_lumos_graph/test_graph/test_estimate_mode.py::test_node_grounding_estimate_calls_estimate_without_claim_artifact
    """
    captured: dict[str, object] = {}
...
def test_node_relevance_estimate_calls_estimate_with_claims_and_question(
    ...
    Run: uv run pytest -s packages/lumos-graph/test_lumos_graph/test_graph/test_estimate_mode.py::test_node_relevance_estimate_calls_estimate_with_claims_and_question
    """
    captured: dict[str, object] = {}
...
def test_node_report_sets_cost_estimate_in_estimate_mode(graph_module) -> None:
    ...
    Run: uv run pytest -s packages/lumos-graph/test_lumos_graph/test_graph/test_estimate_mode.py::test_node_report_sets_cost_estimate_in_estimate_mode
    """
    state = {
        "execution_mode": "estimate",
        "target_node": "eval",
