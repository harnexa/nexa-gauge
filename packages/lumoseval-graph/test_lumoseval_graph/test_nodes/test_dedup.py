# Debug commands:
# uv run pytest -s packages/lumos-graph/test_lumos_graph/test_nodes/test_dedup.py
# uv run pytest -s packages/lumos-graph/test_lumos_graph/test_nodes/test_dedup.py::test_run_returns_dedup_artifacts_from_mocked_deduplicate
# uv run pytest -s -k "dedup" packages/lumos-graph/test_lumos_graph/test_nodes/test_dedup.py

import pytest
from lumoseval_core.types import Item
from lumoseval_graph.nodes import dedup as dedup_module
from lumoseval_graph.nodes.dedup import DedupNode
