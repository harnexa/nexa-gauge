# Debug commands:
# uv run pytest -s packages/lumos-graph/test_lumos_graph/test_nodes/test_claim_extractor.py
# uv run pytest -s packages/lumos-graph/test_lumos_graph/test_nodes/test_claim_extractor.py::test_run_builds_claim_artifacts_with_mocked_llm
# uv run pytest -s -k "claim_extractor" packages/lumos-graph/test_lumos_graph/test_nodes/test_claim_extractor.py

import hashlib
from types import SimpleNamespace

import pytest
from lumoseval_core.types import Chunk, Item
from lumoseval_graph.nodes import claim_extractor as claim_module
from lumoseval_graph.nodes.claim_extractor import ClaimExtractorNode
