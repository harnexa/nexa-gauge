# Debug commands:
# uv run pytest -s packages/lumos-graph/test_lumos_graph/test_llm/test_config.py
# uv run pytest -s packages/lumos-graph/test_lumos_graph/test_llm/test_config.py::test_get_judge_model_prefers_runtime_over_env
# uv run pytest -s -k "llm and config" packages/lumos-graph/test_lumos_graph/test_llm/test_config.py
