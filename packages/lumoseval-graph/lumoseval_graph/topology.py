...
Function objects are NOT stored here — they live in lumos-graph so this
module can be imported by lumos-core, lumos-ingest, lumos-graph,
and lumos-cli without creating circular imports.
"""
...
#   2. Add one entry to NODE_FNS in lumos_graph/registry.py.
#   3. Write the node function in lumos_graph/nodes/metrics/<name>.py.
