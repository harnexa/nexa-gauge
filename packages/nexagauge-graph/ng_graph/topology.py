...
PIPELINE: list[NodeSpec] = [
    ...
    NodeSpec(
        ...
        stream="reference",
        state_key="reference_chunk",
        artifact_in_kind="inputs",
        artifact_out_kind="chunks",
        color="blue_violet",
        is_utility=True,
        env_key_suffixes=("CHUNK_REFERENCE",),
    ),
    NodeSpec(
        name="refine_reference",
        prerequisites=("chunk_reference",),
        requires_reference=True,
        stream="reference",
        state_key="reference_refined_chunks",
        artifact_in_kind="chunks",
        artifact_out_kind="chunks",
        is_transform=True,
        route_via_artifact_graph=True,
        color="sea_green3",
        is_utility=True,
        env_key_suffixes=("REFINE_REFERENCE",),
    ),
    NodeSpec(
        name="claims",
    ...
    NodeSpec(
        ...
        requires_output=True,
        requires_reference=True,
        state_key="refmatch_metrics",
        artifact_in_kind="inputs",
        artifact_out_kind="metric_results",
        is_metric=True,
        color="bright_magenta",
        env_key_suffixes=("REFMATCH",),
    ),
    NodeSpec(
        name="refalign",
        prerequisites=("refiner", "refine_reference"),
        requires_output=True,
        requires_reference=True,
        state_key="refalign_metrics",
        artifact_in_kind="none",
        artifact_out_kind="metric_results",
        is_metric=True,
        color="orchid",
        env_key_suffixes=("REFALIGN",),
    ),
    NodeSpec(
        name="eval",
        prerequisites=(
