...
app = typer.Typer(name="lumos", help="Agentic LLM evaluation pipeline.")
...
def run(*args: Any, **kwargs: Any) -> None:
    ...
    import lumoseval_api.cli.run as run_module
...
def estimate(*args: Any, **kwargs: Any) -> None:
    """Backward-compatible callable used by tests and programmatic callers."""
    import lumoseval_api.cli.estimate as estimate_module
