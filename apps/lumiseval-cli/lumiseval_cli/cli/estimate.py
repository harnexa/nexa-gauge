...
def estimate(
    ...
    table.add_column("eligible_uncached", justify="right")
    table.add_column("eligible_uncached_pct", justify="right")
    ...
    for node, model, status, executed, cached, eligible, eligible_pct, cost in rows:
        ...
        table.add_row(node, model, status, executed, cached, eligible, eligible_pct, display_cost)
